...
rocblas_status RunGPUImplNaive(thrust::device_vector<float>& A,
...
rocblas_status RunGPUImplLDS(thrust::device_vector<float>& A,
                             thrust::device_vector<float>& B,
                             thrust::device_vector<float>& C,
                             rocblas_int m,
                             rocblas_int n,
...
rocblas_status RunGPUImplRegisters(thrust::device_vector<float>& A,
                                   thrust::device_vector<float>& B,
                                   thrust::device_vector<float>& C,
                                   rocblas_int m,
                                   rocblas_int n,
...
rocblas_status RunGPUImplTensorCore(thrust::device_vector<float>& A,
                                    thrust::device_vector<float>& B,
                                    thrust::device_vector<float>& C,
                                    rocblas_int m,
                                    rocblas_int n,
